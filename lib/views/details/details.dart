...
import 'package:mi_ebook/components/description_text.dart';
import 'package:mi_ebook/components/loading_widget.dart';
import 'package:mi_ebook/database/locator_helper.dart';
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback(
      (_) {
        ...
        Provider.of<DetailsProvider>(context, listen: false)
            .getFeed(widget.entry.author.uri.t.replaceAll(r'\&lang=fr', ''));
      },
    );
  }
        ...
        return Scaffold(
          ...
          body: ListView(
            ...
            children: <Widget>[
              ...
              _buildSectionTitle('Description du livre'),
              _buildDivider(),
              SizedBox(height: 10.0),
              ...
              SizedBox(height: 30.0),
              _buildSectionTitle('Plus de l\'auteur'),
              _buildDivider(),
              SizedBox(height: 10.0),
